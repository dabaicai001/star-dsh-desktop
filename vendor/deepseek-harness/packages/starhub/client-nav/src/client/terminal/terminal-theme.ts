...
export interface TerminalTheme { background: string; foreground: string }
...
export function dshTerminalTheme(dark: boolean): TerminalTheme {
  return dark
    ? { background: '#1b1b1c', foreground: '#f9fafb' }  // neutral-bluish-900 / -50
    : { background: '#f5f6f7', foreground: '#1f2329' }  // neutral-bluish-75 / near-black
}
