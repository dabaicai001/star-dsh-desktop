          ...
          >
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <img className={css.brandLogo} src="/starhub-logo.png" alt="StarHub" /> })}
              </span>
              <span className={css.brandName}>
                {renderSlot('sidebar.brand.name', {}, {
                  fallback: <img className={css.brandBadge} src="/starhub-badge.png" alt="StarHub harness" />,
                })}
              </span>
            </span>
          </button>
