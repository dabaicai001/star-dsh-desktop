...
This file defines document structure, Markdown tiers, and writing rules. Use [dsh-doc-standards](../.agents/skills/dsh-doc-standards/SKILL.md) for placement and validation, and [dsh-prose-standard](../.agents/skills/dsh-prose-standard/SKILL.md) for required coverage and editorial judgment; the [doc-tiers Agent Note](../.agents/notes/implemented/process/2026-07-04-doc-tiers-and-budgets.md) owns rationale. The StarHub vendor copy retires the markdown-wrap, doc-budgets, and translation-pairing gates; the bilingual-pair convention below remains advisory.
...
| [user/](user/index.md) | Product-facing guides | Generated reference tables, contributor procedures, decision history |
